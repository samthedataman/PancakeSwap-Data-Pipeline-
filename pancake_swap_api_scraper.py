...
credentials = ServiceAccountCredentials.from_json_keyfile_name('Pancake Scraper-v1/poocoin-331423-6227f4a5365e.json', scopes)
gc = gspread.authorize(credentials)

#opening google sheet Poo Coin Scraper v2
sheet = gc.open("Pancake Scraper")
           
# getting sheet dimension for Poocoin Live Data Feed

Poocoin_Live_Data_Feed = sheet.worksheet("Pancake Scraper Live Data Feed")
...
#retreiving address data from api
TOKEN_ADDRESSES = []
for i in data['data']:
    TOKEN_ADDRESSES.append(i)

TOKEN_DATA = []
#getting unique token addresses my created a fstring json structure
...
# ###adding custom tokens based on user input via google sheet
...
wks = 'Pancake Scraper Live Data Feed'
